...
<section class="gallery-block gallery-front">
        <div class="container">
          <div class="contact-form text-center">
            <h3>Boking <span>Message</span></h3>
          </div>
          <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div class="gallery-image">
                ...
                <div class="overlay">
                  ...
                  ></a>
                  <p><a href="/d_max">HOTEL D-MAX</a></p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div class="gallery-image">
                ...
                <div class="overlay">
                  <a
                    class="info pop example-image-link img-responsive"
                    href="images/room2.png"
                    data-lightbox="example-1"
                    ><i class="fa fa-search" aria-hidden="true"></i
                  ></a>
                  <p><a href="/raja">RAJA HOTEL</a></p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div class="gallery-image">
                ...
                <div class="overlay">
                  <a
                    class="info pop example-image-link img-responsive"
                    href="images/room3.png"
                    data-lightbox="example-1"
                    ><i class="fa fa-search" aria-hidden="true"></i
                  ></a>
                  <p><a href="/queen">HOTEL QUEEN</a></p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div class="gallery-image">
                ...
                <div class="overlay">
                  <a
                    class="info pop example-image-link img-responsive"
                    href="images/room4.png"
                    data-lightbox="example-1"
                    ><i class="fa fa-search" aria-hidden="true"></i
                  ></a>
                  <p><a href="/garden">HOTEL Gren Garden</a></p>
                </div>
              </div>
            </div>
          </div>
