    ...
    <div class="container">
        <form action="/ubah/{{$boking->id_booking}}" method="POST">
            ...
            <div class="input-group">
                ...
                <input type="text" id="" name="nm" value="{{$boking->nm}}">
            </div>
            <div class="check-in">
                <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="text" id="adults" min="50" name="fasilitas" value="{{$boking->fasilitas}}">
            </div>
            <br />
            <div class="input-group">
                <label for="fasilitas">E-mail</label>
                <input type="email" id="adults" min="50" name="email" value="{{$boking->email}}">
            </div>
            <br>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="text" id="adults" min="50" name="jumlah_tamu" value="{{$boking->jumlah_tamu}}">
            </div>
            <div class="flex">
