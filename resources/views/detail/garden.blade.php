<!DOCTPYE HTML>
  ...
  <body>
    <dl>
      <dt style="text-align: center;">Hotel Garden</dt>
    ...
    <div class="container">
      <div class="image-center" style="align-self: center;">
      ...
      <form action="/booking" method="POST">
        <div class="row">
          <div class="d-flex justify-content-around">
            ...
            <div class="col-md-4">
              <h3 style="text-align: center;"> <u> Tentang Kamar </u></h3></br>
